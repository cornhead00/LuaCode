...
{
   static Dictionary<string, string> nextNameFindMap = new Dictionary<string, string>(){{"s1", "s2"}, {"s1_update", "s1_update1"}, {"event_stop", "event_stop1"}, {"Compile", "Compile1"}, {"NotifyParentDoNext", "NotifyParentDoNext1"}, };

   static Dictionary<string, int> methodFindMap = new Dictionary<string, int>(){{"s1", 0}, {"s1_update", 0}, {"event_stop", 1}, {"Compile", 2}, {"NotifyParentDoNext", 3}, };
